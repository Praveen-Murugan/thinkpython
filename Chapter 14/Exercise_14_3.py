"""
If you download my solution to Exercise 4 from http://thinkpython.com/code/anagram_sets.py,
...
Write a module that imports anagram_sets and provides two new functions: store_anagrams should store the anagram dictionary in a “shelf;”
